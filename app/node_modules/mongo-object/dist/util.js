 ...
 */
export function cleanNulls(doc, isArray = false, keepEmptyStrings = false) {
 ...
 *   of each key is "".
 */
export function reportNulls(flatDoc, keepEmptyStrings = false) {
    const nulls = {};
...
export function genericKeyAffectsOtherGenericKey(key, affectedKey) {
...
export function isNullUndefinedOrEmptyString(val) {
 ...
 */
export function makeKeyGeneric(key) {
    if (typeof key !== 'string')
        return null;
    return key.replace(/\.([0-9]+|\$\[[^\]]*\])(?=\.|$)/g, '.$');
}
export function keyToPosition(key, wrapAll = false) {
    let position = '';
 ...
 * @param obj Object
 */
export function expandKey(val, key, obj) {

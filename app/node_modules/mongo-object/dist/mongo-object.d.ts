...
export declare type MongoDoc = Record<string, unknown>;
...
export default class MongoObject {
     ...
     */
    getInfoForKey(key: string): KeyInfo | void;
    /**
     ...
     *   Example: 'foo[bar][0]'
     */
    getPositionForKey(key: string): string | void;
    /**
     ...
     * @returns
     */
    addKey(key: string, val: any, op: string): void;
    /**

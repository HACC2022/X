 ...
 */
export declare function cleanNulls(doc: Record<string, any>, isArray?: boolean, keepEmptyStrings?: boolean): {};
/**
...
export declare function each(collection: any, iteratee: (item: any, keyOrIndex: number | string, obj: any) => boolean | void): void;

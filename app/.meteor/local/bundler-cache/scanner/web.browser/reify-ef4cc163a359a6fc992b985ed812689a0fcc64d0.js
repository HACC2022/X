module.export({Await:()=>Await,MemoryRouter:()=>MemoryRouter,Navigate:()=>Navigate,Outlet:()=>Outlet,Route:()=>Route,Router:()=>Router,RouterProvider:()=>RouterProvider,Routes:()=>Routes,UNSAFE_DataRouterContext:()=>DataRouterContext,UNSAFE_DataRouterStateContext:()=>DataRouterStateContext,UNSAFE_DataStaticRouterContext:()=>DataStaticRouterContext,UNSAFE_LocationContext:()=>LocationContext,UNSAFE_NavigationContext:()=>NavigationContext,UNSAFE_RouteContext:()=>RouteContext,UNSAFE_enhanceManualRouteObjects:()=>enhanceManualRouteObjects,createMemoryRouter:()=>createMemoryRouter,createRoutesFromChildren:()=>createRoutesFromChildren,createRoutesFromElements:()=>createRoutesFromChildren,renderMatches:()=>renderMatches,useActionData:()=>useActionData,useAsyncError:()=>useAsyncError,useAsyncValue:()=>useAsyncValue,useHref:()=>useHref,useInRouterContext:()=>useInRouterContext,useLoaderData:()=>useLoaderData,useLocation:()=>useLocation,useMatch:()=>useMatch,useMatches:()=>useMatches,useNavigate:()=>useNavigate,useNavigation:()=>useNavigation,useNavigationType:()=>useNavigationType,useOutlet:()=>useOutlet,useOutletContext:()=>useOutletContext,useParams:()=>useParams,useResolvedPath:()=>useResolvedPath,useRevalidator:()=>useRevalidator,useRouteError:()=>useRouteError,useRouteLoaderData:()=>useRouteLoaderData,useRoutes:()=>useRoutes});let invariant,resolveTo,joinPaths,matchPath,warning,parsePath,matchRoutes,Action,isRouteErrorResponse,createMemoryHistory,stripBasename,AbortedDeferredError,createRouter;module.link('@remix-run/router',{invariant(v){invariant=v},resolveTo(v){resolveTo=v},joinPaths(v){joinPaths=v},matchPath(v){matchPath=v},warning(v){warning=v},parsePath(v){parsePath=v},matchRoutes(v){matchRoutes=v},Action(v){Action=v},isRouteErrorResponse(v){isRouteErrorResponse=v},createMemoryHistory(v){createMemoryHistory=v},stripBasename(v){stripBasename=v},AbortedDeferredError(v){AbortedDeferredError=v},createRouter(v){createRouter=v}},0);module.link('@remix-run/router',{AbortedDeferredError:"AbortedDeferredError",Action:"NavigationType",createPath:"createPath",defer:"defer",generatePath:"generatePath",isRouteErrorResponse:"isRouteErrorResponse",json:"json",matchPath:"matchPath",matchRoutes:"matchRoutes",parsePath:"parsePath",redirect:"redirect",resolvePath:"resolvePath"},1);let React;module.link('react',{"*"(v){React=v}},2);/**
 * React Router v6.4.2
 *

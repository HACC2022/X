let MongoObject;module.link('mongo-object',{default(v){MongoObject=v}},0);let SimpleSchema;module.link('./SimpleSchema.js',{SimpleSchema(v){SimpleSchema=v}},1);let appendAffectedKey,getParentOfKey,isObjectWeShouldTraverse,looksLikeModifier;module.link('./utility/index.js',{appendAffectedKey(v){appendAffectedKey=v},getParentOfKey(v){getParentOfKey=v},isObjectWeShouldTraverse(v){isObjectWeShouldTraverse=v},looksLikeModifier(v){looksLikeModifier=v}},2);let allowedValuesValidator;module.link('./validation/allowedValuesValidator.js',{default(v){allowedValuesValidator=v}},3);let requiredValidator;module.link('./validation/requiredValidator.js',{default(v){requiredValidator=v}},4);let typeValidator;module.link('./validation/typeValidator/index.js',{default(v){typeValidator=v}},5);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};

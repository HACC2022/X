module.export({default:()=>ValidationContext});let MongoObject;module.link('mongo-object',{default(v){MongoObject=v}},0);let doValidation;module.link('./doValidation.js',{default(v){doValidation=v}},1);
